  ...
  return (
    <div className="bg-[#020617] min-h-screen pb-20 pt-32">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center px-4 py-1.5 rounded-full bg-orange-500/10 border border-orange-500/20 text-orange-400 text-xs font-bold tracking-widest uppercase mb-6">
        ...
        >
          ...
          <section>
            ...
            <div className="bg-[#0f172a] p-6 rounded-xl border border-white/5">
                <h3 className="text-white font-bold mb-3 text-sm">Types of Cookies We Use:</h3>
          ...
          <section>
            <div className="flex items-center mb-4">
              <Settings className="text-gray-400 mr-3" size={24} />
              <h2 className="text-xl font-bold text-white">3. Disabling Cookies</h2>
            </div>
            <p className="text-slate-400 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              ...
              <br /><br />
              For more information, you can contact us at: <span className="text-white">info@techsafi.com</span>
            </p>
          </section>
        </MotionDiv>
