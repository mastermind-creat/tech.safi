  ...
  return (
    <div className="bg-slate-50 dark:bg-[#020617] min-h-screen pb-20 pt-32 transition-colors duration-300">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center px-4 py-1.5 rounded-full bg-blue-100 dark:bg-blue-500/10 border border-blue-200 dark:border-blue-500/20 text-blue-600 dark:text-blue-400 text-xs font-bold tracking-widest uppercase mb-6">
        ...
        >
          ...
          <section>
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-xl font-bold text-slate-900 dark:text-white">3. Data Security</h2>
            </div>
          ...
          <section>
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-xl font-bold text-slate-900 dark:text-white">4. Third-Party Disclosure</h2>
            </div>
            <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
          ...
          <section>
            ...
            <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
              ...
              <br /><br />
              <span className="text-slate-900 dark:text-white font-bold">Email:</span> privacy@techsafi.com<br />
              <span className="text-slate-900 dark:text-white font-bold">Address:</span> Nairobi, Kenya
            </p>
          </section>
        </MotionDiv>
