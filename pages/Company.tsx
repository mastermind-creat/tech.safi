...
export const Company: React.FC = () => {
   ...
   const visionaries = [
      {
         ...
         shortRole: "CEO",
         image: "/images/Team/Kennedy_profile.png",
      ...
      },
      {
         ...
         shortRole: "COO",
         image: "/images/Team/Lewis_profile.png",
      ...
      },
      {
         ...
         shortRole: "CTO",
         image: "/images/Team/simiyu_profile.png",
      ...
      },
      {
         ...
         shortRole: "CIO",
         image: "/images/Team/keith_profile.png",
      ...
      },
      {
         ...
         shortRole: "CSO",
         image: "/images/Team/vinich_profile.png",
   ...
   const SocialIcon: React.FC<{ type: string, leaderColor: string }> = ({ type, leaderColor }) => {
      const className = `w-10 h-10 rounded-xl bg-slate-100 dark:bg-white/5 flex items-center justify-center text-slate-500 dark:text-slate-400 hover:text-white transition-all duration-300 cursor-pointer border border-transparent hover:border-white/10`;
      ...
      return (
         <div className="relative group/icon">
            <div className={`absolute inset-0 bg-gradient-to-br ${leaderColor} opacity-0 group-hover/icon:opacity-100 rounded-xl blur-[2px] transition-opacity duration-300`}></div>
            <div className={`${className} group-hover/icon:bg-transparent group-hover/icon:scale-110 relative z-10`}>
               {getIcon()}
            </div>
         </div>
      );
      ...
      <div className="pb-20 overflow-x-hidden bg-slate-50 dark:bg-[#020617] transition-colors duration-300">
         ...
         <div className="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-slate-900 dark:bg-[#020617]">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20 pb-20">
               ...
               >
                  <div className="flex items-center space-x-4 bg-white/10 backdrop-blur-lg border border-white/20 px-6 py-4 rounded-2xl min-w-[200px] hover:bg-white/20 transition-colors cursor-default shadow-xl">
                     ...
                     <div className="text-left">
                        ...
                        <div className="text-[11px] text-slate-300 uppercase tracking-widest font-semibold">Team Members</div>
                     </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4 bg-white/10 backdrop-blur-lg border border-white/20 px-6 py-4 rounded-2xl min-w-[200px] hover:bg-white/20 transition-colors cursor-default shadow-xl">
                     ...
                     <div className="text-left">
                        ...
                        <div className="text-[11px] text-slate-300 uppercase tracking-widest font-semibold">Projects Done</div>
                     </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4 bg-white/10 backdrop-blur-lg border border-white/20 px-6 py-4 rounded-2xl min-w-[200px] hover:bg-white/20 transition-colors cursor-default shadow-xl">
                     ...
                     <div className="text-left">
                        ...
                        <div className="text-[11px] text-slate-300 uppercase tracking-widest font-semibold">Satisfaction</div>
                     </div>
                  </div>
               </MotionDiv>
            </div>
         ...
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 relative z-20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
               ...
               >
                  ...
                  {/* Stats Row */}
                  <div className="grid grid-cols-3 gap-8 mt-12 border-t border-slate-200 dark:border-white/10 pt-8">
                     ...
                     <div className="text-center md:text-left">
                        <div className="text-4xl font-bold text-blue-600 dark:text-blue-500 mb-2">5+</div>
                        <div className="text-xs text-slate-500 font-medium uppercase tracking-wide">Team Members</div>
                     </div>
                     <div className="text-center md:text-left">
                        <div className="text-4xl font-bold text-blue-600 dark:text-blue-500 mb-2">3+</div>
               ...
               >
                  <img src="/images/Team/company_1.jpg" className="w-full h-48 md:h-56 object-cover rounded-2xl border border-slate-200 dark:border-white/10 shadow-lg hover:scale-[1.02] transition-transform duration-300" alt="TechSafi Team Work" />
                  <img src="/images/Team/company_2.png" className="w-full h-48 md:h-56 object-cover rounded-2xl border border-slate-200 dark:border-white/10 shadow-lg mt-8 hover:scale-[1.02] transition-transform duration-300" alt="TechSafi Meeting" />
                  <img src="https://images.unsplash.com/photo-1573495783078-30b34471804b?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NDJ8fHRlY2glMjB3b3Jrc3BhY2UlMjBhZnJpY2FufGVufDB8fDB8fHww" className="w-full h-48 md:h-56 object-cover rounded-2xl border border-slate-200 dark:border-white/10 shadow-lg -mt-8 hover:scale-[1.02] transition-transform duration-300" alt="TechSafi Collaboration" />
                  <img src="https://plus.unsplash.com/premium_photo-1689700527463-efbf5c2e652c?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTk4fHx0ZWNoJTIwd29ya3NwYWNlJTIwYWZyaWNhbnxlbnwwfHwwfHx8MA%3D%3D" className="w-full h-48 md:h-56 object-cover rounded-2xl border border-slate-200 dark:border-white/10 shadow-lg hover:scale-[1.02] transition-transform duration-300" alt="TechSafi Office" />
               </MotionDiv>
            </div>
         </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
               {visionaries.map((leader, idx) => (
                  ...
                  >
                     ...
                     <div className={`absolute -inset-[2px] rounded-[22px] bg-gradient-to-br ${leader.color} opacity-0 group-hover:opacity-100 blur-[2px] transition-opacity duration-500 z-0`}></div>

                     <div className="relative z-10 h-full rounded-2xl bg-white dark:bg-[#0f172a] border border-slate-200 dark:border-white/5 overflow-hidden flex flex-col transition-all duration-300 shadow-xl dark:shadow-none group-hover:translate-y-[-4px]">
                        {/* Top Image Section */}
                        <div className="relative h-88 overflow-hidden">
                           ...
                           />
                           {/* Role Badge */}
                           <div className={`absolute top-4 right-4 px-3 py-1 rounded-full ${leader.badgeColor} text-white text-[10px] font-bold flex items-center shadow-lg backdrop-blur-md bg-opacity-80`}>
                              {leader.icon} {leader.shortRole}
                           </div>
                           {/* Bottom Image Overlay */}
                           <div className="absolute inset-x-0 bottom-0 h-2/3 bg-gradient-to-t from-white dark:from-[#0f172a] via-transparent to-transparent"></div>
                        </div>

                        {/* Content Section */}
                        <div className="px-8 pb-8 flex flex-col flex-grow -mt-12 relative z-20">
                           <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-1">{leader.name}</h3>
                           <p className={`text-sm font-bold bg-clip-text text-transparent bg-gradient-to-r ${leader.color} mb-4 uppercase tracking-wider`}>
                              {leader.role}
                           </p>
                           ...
                           {/* Stats Grid */}
                           <div className="grid grid-cols-3 gap-4 border-t border-slate-100 dark:border-white/5 pt-6 mb-8 w-full">
                              {leader.stats.map((stat, i) => (
                                 <div key={i} className="text-center">
                                    <div className={`text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-br ${leader.color}`}>
                                       {stat.value}
                                    </div>
                                    <div className="text-[9px] text-slate-500 dark:text-slate-400 uppercase tracking-widest font-bold mt-1">{stat.label}</div>
                                 </div>
                              ))}
                           </div>
                           ...
                           <div className="flex gap-3 justify-center">
                              {leader.socials.map((social, i) => (
                                 <MotionDiv
                                    ...
                                    whileTap={{ scale: 0.9 }}
                                 >
                                    <SocialIcon type={social} leaderColor={leader.color} />
                                 </MotionDiv>
                              ))}
                           </div>
                        </div>
         ...
         <div className="mb-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <MotionDiv
               ...
               className="text-center mb-16"
            >
               <h2 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white font-display mb-4">Executive Leadership Structure</h2>
            ...
            <div className="relative">
               ...
               <div className="flex justify-center mb-8 relative z-10">
                  ...
                  >
                     <Card className="p-8 text-center bg-white dark:bg-[#0f172a] border-slate-200 dark:border-white/10 shadow-xl shadow-blue-500/5 dark:shadow-blue-900/5">
                        <div className="mb-2">
                           <h3 className="text-2xl font-bold text-slate-900 dark:text-white">Wambia Kennedy</h3>
                           <div className="text-sky-500 dark:text-sky-400 text-sm font-bold tracking-wider uppercase mt-1">Chief Executive Officer</div>
                        </div>
               ...
               <div className="hidden md:block absolute top-[160px] left-1/2 -translate-x-1/2 w-full h-12 pointer-events-none">
                  <div className="absolute top-[-32px] left-1/2 -translate-x-px w-[2px] h-12 bg-slate-300 dark:bg-white/10"></div>
                  <div className="absolute top-[14px] left-[16.66%] right-[16.66%] h-[2px] bg-slate-300 dark:bg-white/10"></div>
                  <div className="absolute top-[14px] left-[16.66%] w-[2px] h-8 bg-slate-300 dark:bg-white/10"></div>
                  <div className="absolute top-[14px] left-1/2 -translate-x-px w-[2px] h-8 bg-slate-300 dark:bg-white/10"></div>
                  <div className="absolute top-[14px] right-[16.66%] w-[2px] h-8 bg-slate-300 dark:bg-white/10"></div>
               </div>
               ...
               <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10 mb-20">
                  ...
                  >
                     <Card className="h-full p-6 text-center bg-white dark:bg-[#0f172a] border-slate-200 dark:border-white/10">
                        <h3 className="text-lg font-bold text-slate-900 dark:text-white">Lewis Mwaura</h3>
                        <div className="text-purple-500 dark:text-purple-400 text-xs font-bold tracking-wider uppercase mt-1 mb-3">Chief Operating Officer</div>
                        <p className="text-slate-600 dark:text-slate-400 text-sm">Oversees delivery, internal processes, and day-to-day execution.</p>
                     </Card>
                  </MotionDiv>
                  ...
                  >
                     <Card className="h-full p-6 text-center bg-white dark:bg-[#0f172a] border-slate-200 dark:border-white/10">
                        <h3 className="text-lg font-bold text-slate-900 dark:text-white">Samuel Simiyu</h3>
                        <div className="text-emerald-500 dark:text-emerald-400 text-xs font-bold tracking-wider uppercase mt-1 mb-3">Chief Technology Officer</div>
                        <p className="text-slate-600 dark:text-slate-400 text-sm">Drives product architecture, technical innovation, and AI initiatives.</p>
                     </Card>
                  </MotionDiv>
                  ...
                  >
                     <Card className="h-full p-6 text-center bg-white dark:bg-[#0f172a] border-slate-300 dark:border-white/10 border-dashed">
                        <h3 className="text-lg font-bold text-slate-400 dark:text-white/70">Chief Marketing Officer</h3>
               ...
               <div className="text-center mb-12">
                  <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">Strategic Leadership Additions</h3>
                  <p className="text-slate-600 dark:text-slate-400 text-sm max-w-2xl mx-auto">Two senior leaders have joined the team to strengthen our platform, integrations and security posture as TechSafi scales its AI-powered platform.</p>
               </div>
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10 max-w-4xl mx-auto mb-20">
                  ...
                  <MotionDiv
                     ...
                     transition={{ delay: 0.1 }}
                  >
                     <Card className="h-full p-8 text-center bg-white dark:bg-[#0f172a] border-slate-200 dark:border-white/10">
                        <h3 className="text-xl font-bold text-slate-900 dark:text-white">Keith Keizzah</h3>
                        <div className="text-violet-500 dark:text-violet-400 text-xs font-bold tracking-wider uppercase mt-1 mb-3">Chief Integration Officer (CIO)</div>
                        <p className="text-slate-600 dark:text-slate-400 text-sm">Strengthens our AI and platform engineering capabilities to deliver dependable, production-ready integrations that accelerate customer value.</p>
                     </Card>
                  </MotionDiv>
                  ...
                  >
                     <Card className="h-full p-8 text-center bg-white dark:bg-[#0f172a] border-slate-200 dark:border-white/10">
                        <h3 className="text-xl font-bold text-slate-900 dark:text-white">Vinich Omuga</h3>
                        <div className="text-yellow-500 dark:text-yellow-400 text-xs font-bold tracking-wider uppercase mt-1 mb-3">Chief Security Officer (CSO)</div>
                        <p className="text-slate-600 dark:text-slate-400 text-sm">Enhances the security, trust, and reliability of all TechSafi solutions—ensuring data protection and compliance as we scale.</p>
                     </Card>
                  </MotionDiv>
               </div>
            </div>
         ...
         <div className="mb-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
               <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">Future Leadership Roles</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-5xl mx-auto">
               {[
                  ...
                  <MotionDiv
                     ...
                     transition={{ delay: idx * 0.1 }}
                  >
                     <Card className="h-full p-8 text-center bg-white dark:bg-[#0f172a] border-slate-300 dark:border-white/10 border-dashed group hover:border-slate-400 dark:hover:border-white/20">
                        <div className="w-12 h-12 rounded-lg bg-slate-100 dark:bg-white/5 flex items-center justify-center text-slate-400 mx-auto mb-4 group-hover:text-slate-900 dark:group-hover:text-white transition-colors">
                           {role.icon}
                        </div>
                        <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2">{role.title}</h3>
                        <p className="text-slate-500 dark:text-slate-400 text-sm mb-6">{role.desc}</p>
                        <span className="inline-block px-3 py-1 rounded-full bg-slate-100 dark:bg-white/5 text-slate-500 text-xs font-bold uppercase tracking-wider">Pending Appointment</span>
                     </Card>
                  </MotionDiv>
               ))}
            </div>
         ...
         <div className="mb-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <MotionDiv
               ...
               className="text-center mb-16"
            >
               <div className="inline-flex items-center px-4 py-1.5 rounded-full bg-slate-100 dark:bg-[#1e293b] text-purple-600 dark:text-purple-400 text-xs font-bold tracking-widest uppercase mb-4 border border-purple-500/20">
               ...
               <h2 className="text-3xl md:text-5xl font-bold text-slate-900 dark:text-white font-display mb-4">
                  The <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-500 to-blue-600 dark:from-cyan-400 dark:to-blue-600">Journey</span> So Far
               </h2>
                  ...
                  {milestones.map((milestone, idx) => (
                     ...
                     >
                        ...
                        <div className="z-10 absolute left-1/2 top-0 md:top-8 transform -translate-x-1/2 flex items-center justify-center hidden md:flex">
                           <div className={`w-12 h-12 rounded-full ${milestone.bg} flex items-center justify-center text-white shadow-[0_0_15px_rgba(255,255,255,0.3)] border-4 border-slate-50 dark:border-[#020617]`}>
                              {milestone.icon}
                           </div>
                        </div>
                        ...
                        <div className={`w-full md:w-[45%] ${idx % 2 === 0 ? 'md:pl-0' : 'md:pr-0'} relative`}>
                           {/* Mobile Line/Icon */}
                           <div className="md:hidden flex items-center mb-4 pl-4 border-l-2 border-slate-300 dark:border-slate-700">
                              ...
                              <span className="text-sm font-bold text-slate-700 dark:text-white opacity-80">{milestone.year}</span>
                           </div>

                           <Card className={`p-8 relative overflow-hidden bg-white dark:bg-[#1e293b]/50 border-slate-200 dark:border-white/5 hover:border-slate-300 dark:hover:border-white/10 transition-all ${idx % 2 !== 0 ? 'md:text-right' : 'text-left'}`}>
                              ...
                              <div className={`flex flex-col ${idx % 2 !== 0 ? 'md:items-end' : 'md:items-start'}`}>
                                 ...
                                 <h3 className={`text-2xl font-bold text-slate-900 dark:text-white mb-1 flex items-center gap-2 ${idx % 2 !== 0 ? 'md:flex-row-reverse' : ''}`}>
                                    {milestone.title}
                                 </h3>
                                 ...
                                 <div className={`text-slate-600 dark:text-slate-400 text-sm leading-relaxed mt-4`}>
                                    {milestone.description.split(new RegExp(`(${['Wambia Kennedy', 'Lewis Mwaura', 'Samuel Simiyu', 'Samuel', 'Lewis', 'Kennedy', 'TechSafi'].join('|')})`, 'g')).map((part, i) => (
                                       ['Wambia Kennedy', 'Lewis Mwaura', 'Samuel Simiyu', 'Samuel', 'Lewis', 'Kennedy'].includes(part) ? <span key={i} className={milestone.color + " font-bold"}>{part}</span> :
                                          part === 'TechSafi' ? <span key={i} className="text-slate-900 dark:text-white font-bold">TechSafi</span> :
                                 ...
                                 {['AI', 'IoT'].some(tech => milestone.description.includes(tech)) && idx === 2 && (
                                    <div className={`flex gap-2 mt-4 flex-wrap ${idx % 2 !== 0 ? 'md:justify-end' : ''}`}>
                                       {['AI', 'IoT', 'Cloud'].map(t => (
                                          <span key={t} className="px-2 py-1 rounded bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/5 text-xs text-slate-600 dark:text-slate-300">{t}</span>
                                       ))}
                                    </div>
                                 )}
                              </div>
