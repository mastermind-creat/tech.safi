...
export const Company: React.FC = () => {
  ...
  const SocialIcon: React.FC<{ type: string }> = ({ type }) => {
    const className = "w-8 h-8 rounded-full bg-slate-100 dark:bg-[#1e293b] flex items-center justify-center text-slate-500 dark:text-slate-400 hover:text-white hover:bg-primary transition-colors cursor-pointer";
    switch(type) {
    ...
    <div className="pb-20 overflow-x-hidden bg-slate-50 dark:bg-[#020617] transition-colors duration-300">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 relative z-20">
         <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
                <img src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=400&h=400" className="w-full h-48 md:h-56 object-cover rounded-2xl border border-slate-200 dark:border-white/10 shadow-lg hover:scale-[1.02] transition-transform duration-300" alt="TechSafi Team Work" />
                <img src="https://images.unsplash.com/photo-1531482615713-2afd69097998?auto=format&fit=crop&w=400&h=400" className="w-full h-48 md:h-56 object-cover rounded-2xl border border-slate-200 dark:border-white/10 shadow-lg mt-8 hover:scale-[1.02] transition-transform duration-300" alt="TechSafi Meeting" />
                <img src="https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&w=400&h=400" className="w-full h-48 md:h-56 object-cover rounded-2xl border border-slate-200 dark:border-white/10 shadow-lg -mt-8 hover:scale-[1.02] transition-transform duration-300" alt="TechSafi Collaboration" />
                <img src="https://images.unsplash.com/photo-1542744173-8e7e53415bb0?auto=format&fit=crop&w=400&h=400" className="w-full h-48 md:h-56 object-cover rounded-2xl border border-slate-200 dark:border-white/10 shadow-lg hover:scale-[1.02] transition-transform duration-300" alt="TechSafi Office" />
            </MotionDiv>
         </div>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {visionaries.map((leader, idx) => (
                    <MotionDiv
                        ...
                        transition={{ delay: idx * 0.1 }}
                    >
                        <div className="relative group rounded-2xl bg-white dark:bg-[#0f172a] border border-slate-200 dark:border-white/5 p-8 h-full overflow-hidden hover:border-blue-500/30 dark:hover:border-white/10 transition-all duration-300 shadow-xl dark:shadow-none">
                             {/* Glow Effect */}
                            ...
                            <div className="relative z-10 flex flex-col items-center text-center">
                                ...
                                <div className="w-12 h-0.5 bg-slate-200 dark:bg-white/10 mb-4"></div>
