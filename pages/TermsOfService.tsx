  ...
  return (
    <div className="bg-[#020617] min-h-screen pb-20 pt-32">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="inline-flex items-center px-4 py-1.5 rounded-full bg-purple-500/10 border border-purple-500/20 text-purple-400 text-xs font-bold tracking-widest uppercase mb-6">
        ...
        >
          ...
          <section>
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-xl font-bold text-white">2. Provision of Services</h2>
            </div>
