        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
           <div className="text-center mb-16">
              <MotionDiv
                 ...
                 className="inline-flex items-center px-4 py-1.5 rounded-full bg-[#1e293b] text-blue-400 text-xs font-bold tracking-widest uppercase mb-6 border border-blue-500/20"
              >
              ...
              >
                 <h1 className="text-4xl md:text-6xl font-bold font-display text-white mb-6">
                    TechSafi <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500">Journal</span>
                 </h1>
              </MotionDiv>
           ...
           >
              ...
              <div className="absolute bottom-0 left-0 w-full p-8 md:p-12 z-20">
                 ...
                 <p className="text-slate-300 text-sm md:text-base max-w-2xl mb-6 line-clamp-2">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
         <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div className="lg:col-span-2">
               <h3 className="text-2xl font-bold text-white mb-8 border-l-4 border-blue-500 pl-4">Latest Articles</h3>
                     ...
                     >
                        ...
                        <div className="flex-1 flex flex-col justify-center">
                           <div className="flex items-center gap-3 mb-2">
                              <span className="text-blue-400 text-xs font-bold uppercase tracking-wider">{post.category}</span>
                           ...
                           <div className="flex items-center justify-between mt-auto">
                              ...
                              <span className="text-blue-500 text-xs font-bold flex items-center group-hover:translate-x-1 transition-transform">
            ...
            <div className="lg:col-span-1">
               <div className="sticky top-24 space-y-8">
                  {/* Search */}
                  <div className="bg-[#1e293b]/40 border border-white/5 rounded-xl p-6">
                     <h4 className="text-white font-bold mb-4">Search</h4>
                     <div className="relative">
                        <input 
                           type="text" 
                           placeholder="Search articles..." 
                           className="w-full bg-[#0f172a] border border-white/10 rounded-lg pl-4 pr-10 py-3 text-sm text-white focus:outline-none focus:border-blue-500 transition-colors"
                        />
                     ...
                     <div className="space-y-2">
                        {['Artificial Intelligence', 'Web Development', 'Mobile Apps', 'Cloud Computing', 'Digital Strategy', 'Security'].map((cat, i) => (
                           <div key={i} className="flex items-center justify-between p-2 hover:bg-white/5 rounded-lg cursor-pointer group transition-colors">
                              <span className="text-slate-400 text-sm group-hover:text-white transition-colors">{cat}</span>
                              <span className="text-xs bg-[#0f172a] text-slate-500 px-2 py-0.5 rounded-full">{Math.floor(Math.random() * 10) + 1}</span>
                           </div>
                        ))}
                     </div>
                  </div>
                  ...
                  {/* Newsletter */}
                  <div className="bg-gradient-to-br from-blue-900/40 to-purple-900/40 border border-blue-500/20 rounded-xl p-6 relative overflow-hidden">
                     <div className="relative z-10">
                        <div className="w-10 h-10 bg-blue-600 rounded-lg flex items-center justify-center text-white mb-4 shadow-lg">
                           <Mail size={20} />
                        </div>
                        <h4 className="text-white font-bold mb-2">Weekly Tech Insights</h4>
                        <p className="text-blue-100 text-xs mb-4">Get the latest trends and updates delivered straight to your inbox.</p>
                        <input 
                           type="email" 
                           placeholder="Your email address" 
                           className="w-full bg-black/20 border border-white/10 rounded-lg px-3 py-2 text-sm text-white mb-3 focus:outline-none focus:border-blue-400"
                        />
                        <Button className="w-full bg-blue-600 hover:bg-blue-700 h-9 text-sm">Subscribe</Button>
                     </div>
                  </div>
               </div>
            </div>
